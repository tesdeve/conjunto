...
class ResidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resident" do
    assert_difference('Resident.count') do
      post residents_url, params: { resident: { principal: @resident.principal, property_id: @resident.property_id } }
    end
  ...
  test "should update resident" do
    patch resident_url(@resident), params: { resident: { principal: @resident.principal, property_id: @resident.property_id } }
